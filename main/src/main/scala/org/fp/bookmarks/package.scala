...
package object bookmarks {
  ...
  /**
    ...
    */
  val ann_makeYourOwnTypeClasses = Annotation(herdingCats, "https://hyp.is/6TGlfiwMEea_38vRFJt4xQ/archive.is/jnGcW")
  val ann_FunctionSyntax = Annotation(herdingCats, "http://archive.is/xhOwY#annotations:7jPreCwBEeagtMfxykENBg")
  //@todo
  ...
  val ann_stackOverflow_typeLambdaAndBenefits_bkm1 = Annotation(so_typeLambdaAndBenefits,
  ...
  val ann_cakeSolutions_ExistentialTypesInScala_bkm1 = Annotation(cakeSolutions_ExistentialTypesInScala,
    "https://hyp.is/mLbLNJLzEeeDzEtRoAGGBA/archive.is/i17zj")
